...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--source_video_path",
        required=False,
        default="C:/Users/Asus/Downloads/mv_video.mp4",
    ...
    parser.add_argument(
        "--target_video_path",
        required=False,
        default="C:/Users/Asus/Downloads/lab.mp4",
...
if __name__ == "__main__":
    ...
    with sv.VideoSink(args.target_video_path, video_info) as sink:
        for frame in frame_generator:
            ...
            # Update vehicle count for new tracker_ids
            for tracker_id in detections.tracker_id:
                if tracker_id not in counted_tracker_ids:
