...
def find_lane_center_point(img, lines, draw=True):
    if lines is not None:
        ...
        if draw == True:
            ...
            # cv2.circle(img, traj_top_point, 15, (255, 0, 0), -1)
            # cv2.circle(img, traj_bottom_point, 15, (255, 0, 0), -1)
            # four points from both lane
            # cv2.circle(img, (left_x1, left_y1), 15, (255, 0, 0), -1)
            # cv2.circle(img, (left_x2, left_y2), 15, (0, 255, 0), -1)
            # cv2.circle(img, (right_x1, right_y1), 15, (0, 0, 255), -1)
            # cv2.circle(img, (right_x2, right_y2), 15, (255, 0, 255), -1)
